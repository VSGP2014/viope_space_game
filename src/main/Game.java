...
public class Game {
	...
	public Universe buildUniverse(){
		...
		//Jupiter
		Body io = new Body("Io",ConstantsUniverse.IO_MASS,ConstantsUniverse.IO_SIZE,new Vector(new BigDecimal("-694294830665"),new BigDecimal("375901422954")),new Vector((new BigDecimal("0")).multiply(iv),(new BigDecimal("17334")).multiply(iv)), Color.green);
